              ...
              children: [
                ...
                BlocConsumer<AuthCubit, AuthStates>(listener: (context, state) {
                  ...
                  if (state is SendOtpSuccessState) {
                    ...
                    debugPrint(widget.nameController.text);
                    debugPrint(widget.phoneController.text);
                    debugPrint(widget.cityController.text);
                    debugPrint(widget.emailController.text);
                    debugPrint(widget.passController.text);
                    debugPrint("*********************");
                    customPushNavigator(
                        context,
                        VerifyPhoneScreen(
                            verificationOtp: context.read<AuthCubit>().otpCode,
                            gender: context.read<AuthCubit>().genderValue,
                            name: widget.nameController.text,
                            phone: widget.phoneController.text,
                            city: widget.cityController.text,
                            brithDate: context.read<AuthCubit>().brithDateController.text,
