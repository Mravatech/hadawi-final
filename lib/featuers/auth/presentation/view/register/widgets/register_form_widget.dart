              ...
              children: [
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      value: context.read<AuthCubit>().dropdownCity.isEmpty
                          ? null
                          : context.read<AuthCubit>().dropdownCity,
                      ...
                      isExpanded: true,
                      // This is important to fill the container width
                    ...
                    return GestureDetector(
                      onTap: () => showDatePicker(
                        ...
                        lastDate: DateTime.now(),
                          ...
                          cubit.setBrithDate(brithDateValue: value!)),
                ...
                BlocConsumer<AuthCubit, AuthStates>(listener: (context, state) {
                  ...
                  if (state is SendOtpSuccessState) {
                    UserDataFromStorage.setUserName(widget.nameController.text);
                    UserDataFromStorage.setPhoneNumber(
                        '+966${widget.phoneController.text}');
                    UserDataFromStorage.setEmail(widget.emailController.text);
                    UserDataFromStorage.setCity(cubit.dropdownCity);
                      ...
                      : DefaultButton(
                          ...
                          onPressed: () {
                            if (registerKey.currentState!.validate()) {
                              if (context.read<AuthCubit>().dropdownCity.isNotEmpty) {
