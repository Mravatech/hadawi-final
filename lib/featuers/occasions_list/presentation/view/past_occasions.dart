...
class PastOccasions extends StatefulWidget {
  ...
  @override
  State<PastOccasions> createState() => _PastOccasionsState();
}

class _PastOccasionsState extends State<PastOccasions> {
  @override
  void initState() {
    OccasionsListCubit.get(context).getPastOccasionsList();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<OccasionsListCubit, OccasionsListStates>(
      ...
      builder: (context, state) {
        if (state is GetPastOccasionListLoadingState) {
          return Center(
        ...
        final occasions = OccasionsListCubit.get(context).pastOccasionsList;
        
        if (state is GetPastOccasionListSuccessState && occasions.isNotEmpty) {
          return RefreshIndicator(
            color: Color(0xFF8B7BA8),
            onRefresh: () async {
              await OccasionsListCubit.get(context).getPastOccasionsList();
            },
