...
class DeleteOccasionsWidget extends StatefulWidget {
  final String occasionId;
  final bool fromHome;

  const DeleteOccasionsWidget(
      {super.key, required this.occasionId, required this.fromHome});

  @override
  State<DeleteOccasionsWidget> createState() => _OccasionDetailsState();
}

class _OccasionDetailsState extends State<DeleteOccasionsWidget> {
  int _currentIndex = 0;
